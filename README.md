...
## Outputs
**dac_out:** Binary (1 bit). Pulse Code Modulation (PCM) Signal. In order to recover the baseline signal, this output has to be low-pass filtered in the analog domain.  
